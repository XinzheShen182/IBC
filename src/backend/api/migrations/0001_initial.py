# Generated by Django 3.1.14 on 2024-03-07 18:16
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(default='agent-dfc458492e574c659333b2ebebacb778', help_text='Agent name, can be generated automatically.', max_length=64)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('drawn', 'drawn'), ('chaincode', 'chaincode'), ('installed', 'installed'), ('executing', 'executing')], default='pending', help_text='status of BpmnStoragedFile', max_length=32)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(default='netowrk-816e85c712db4a3f97497fcbf62cc4a7', help_text='network name, can be generated automatically.', max_length=64)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Initiated', 'Initiated'), ('Enrolling', 'Enrolling'), ('Fullfilled', 'Fullfilled'), ('Generated', 'Generated')], default='pending', help_text='status of BPMNInstance', max_length=32)),
                ...
                ('start_time', models.DateTimeField(blank=True, help_text='Start time of BPMNInstance', null=True)),
                ('end_time', models.DateTimeField(blank=True, help_text='End time of BPMNInstance', null=True)),
                ('chaincode_contend', models.TextField(blank=True, default=None, help_text='content of chaincode file', null=True)),

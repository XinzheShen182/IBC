...
SwapInitiatingParticipantHandler.$inject = ['eventBus', 'modeling'];
...
SwapInitiatingParticipantHandler.prototype.preExecute = function (context) {
  ...
  const initParticipantBand = activityShape.children.find(x => x.businessObject === activityShape.businessObject.initiatingParticipantRef);
  assign(context, {

...
ParticipantLinkingPopupProvider.$inject = ['injector', 'popupMenu', 'modeling', 'moddle'];
ParticipantLinkingPopupProvider.prototype.getEntries = function (element) {
  ...
  if (callChoreoBo.participantAssociations) {
    const participantAssociation = callChoreoBo.participantAssociations.find(pa => pa.outerParticipantRef === element.businessObject);

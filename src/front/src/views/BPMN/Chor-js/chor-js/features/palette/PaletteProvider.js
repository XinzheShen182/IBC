...
PaletteProvider.prototype.getPaletteEntries = function (element) {
  ...
  assign(actions, {
    ...
    'create.choreography-task': createAction('bpmn:ChoreographyTask', 'choreography', 'choreo-icon-choreography-task'),
    'create.subchoreography-collapsed': createAction('bpmn:SubChoreography', 'choreography', 'choreo-icon-subchoreography-collapsed', 'Create collapsed SubChoreography', {
      isExpanded: false,
      collapsed: true
    }),
    'create.subchoreography-expanded': createAction('bpmn:SubChoreography', 'choreography', 'choreo-icon-subchoreography-expanded', 'Create expanded SubChoreography', {
      isExpanded: true,
      collapsed: false
    }),
    'create.callchoreography-collapsed': createAction('bpmn:CallChoreography', 'choreography', 'choreo-icon-callchoreography-collapsed', 'Create collapsed Call Choreography', {
      isExpanded: false,
      collapsed: true
    }),
    'choreo-separator': {
    ...
    'create.event-based-gateway': createAction('bpmn:EventBasedGateway', 'gateway', 'bpmn-icon-gateway-eventbased')
  });
  return actions;
};
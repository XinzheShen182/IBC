...
import { displayChoreography, clearShapeCache } from './import/ImportHandler';
...
Modeler.prototype._modules = [].concat(BaseModeler.prototype._modules, [CoreModule, ContextPadModule, KeyboardModule, KeyboardMoveSelectionModule, LabelEditingModule, ModelingModule, PaletteModule, PopupMenuModule, ResizeModule, RulesModule, CopyPasteModule, SwitchModule, BpmnDiOrdering, ChoreoSpaceToolModule]);

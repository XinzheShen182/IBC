        ...
        <div>
            ...
            >
                ...
                <div className='button-group'
                    ...
                    <button id="js-download-diagram" className="icon-file-code" title="Download BPMN XML file"></button>
                    <button id="js-download-svg" className="icon-file-image" title="Download as SVG image"></button>
                </div>
            </Modal >
        </div>
    );

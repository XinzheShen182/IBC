...
export default {
  __init__: ['createChoreoTaskBehavior', 'removeParticipantBehavior', 'resizeParticipantBehavior', 'deleteMessageBehavior', 'toggleChoreoCollapseBehavior', 'choreoSpaceToolBehavior'],

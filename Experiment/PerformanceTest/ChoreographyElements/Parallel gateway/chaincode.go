...
func (cc *SmartContract) InitLedger(ctx contractapi.TransactionContextInterface) error {
	...
	cc.CreateActionEvent(ctx, "Event_129hvdl", ENABLE)
	cc.CreateGateway(ctx, "Gateway_0og04ux", DISABLE)
	cc.CreateMessage(ctx, "Message_0gpiru4", "Member2.org.comMSP", "Member1.org.comMSP", "", DISABLE, "{\"properties\":{\"123\":{\"type\":\"string\",\"description\":\"\"}},\"required\":[],\"files\":{},\"file required\":[]}")
	cc.CreateMessage(ctx, "Message_1hzruzz", "Member2.org.comMSP", "Member1.org.comMSP", "", DISABLE, "{\"properties\":{\"321\":{\"type\":\"string\",\"description\":\"\"}},\"required\":[],\"files\":{},\"file required\":[]}")
	cc.CreateGateway(ctx, "Gateway_1vhmdy5", DISABLE)
	cc.CreateActionEvent(ctx, "Event_0btml5q", DISABLE)
...
func (cc *SmartContract) Event_129hvdl(ctx contractapi.TransactionContextInterface) error {
	...
	cc.ChangeEventState(ctx, "Event_129hvdl", DONE)
	stub.SetEvent("Event_129hvdl", []byte("Contract has been started successfully"))
...
func (cc *SmartContract) Message_0gpiru4_Send(ctx contractapi.TransactionContextInterface, fireflyTranID string) error {
	stub := ctx.GetStub()
	msg, err := cc.ReadMsg(ctx, "Message_0gpiru4")
	if err != nil {
		return err
	}
...
func (cc *SmartContract) Message_1hzruzz_Send(ctx contractapi.TransactionContextInterface, fireflyTranID string) error {
	stub := ctx.GetStub()
	msg, err := cc.ReadMsg(ctx, "Message_1hzruzz")
	if err != nil {
		return err
	}
...
func (cc *SmartContract) Event_0btml5q(ctx contractapi.TransactionContextInterface) error {
	...
	cc.ChangeEventState(ctx, "Event_0btml5q", DONE)
